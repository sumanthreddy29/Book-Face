      ...
      <Grid container justify = "center" spacing={3}>
        <Grid item xs={8}>
          <Paper  className={classes.paper}>
              <h2 align="center" >Privacy Notice</h2>
              <hr></hr>
              <p>
              This privacy notice discloses the privacy practices forBookface . This privacy notice applies solely to information collected by this website. It will notify you of the following:
              </p>
              <ul>
          ...
          <h3>If you feel that we are not abiding by this privacy policy, you should contact us immediately  via email.</h3>
          </Paper>
